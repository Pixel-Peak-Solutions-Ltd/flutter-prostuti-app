...
class CourseLeaderboardView extends ConsumerStatefulWidget {
  ...
  @override
  _CourseLeaderboardViewState createState() => _CourseLeaderboardViewState();
}

class _CourseLeaderboardViewState extends ConsumerState<CourseLeaderboardView>
    with CommonWidgets {
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >=
      ...
      final leaderboardNotifier =
          ref.read(courseLeaderboardProvider(widget.courseId).notifier);
  ...
  Widget build(BuildContext context) {
    final courseLeaderboardAsyncValue =
        ref.watch(courseLeaderboardProvider(widget.courseId));
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ref
              .read(courseLeaderboardProvider(widget.courseId).notifier)
              .refreshLeaderboard();
        },
        child: courseLeaderboardAsyncValue.when(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (remaining.isNotEmpty) ...[
                    ...
                    if (ref
                        .read(
                            courseLeaderboardProvider(widget.courseId).notifier)
                        .hasMore)
                      const Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "No leaderboard data for this course",
            style: Theme.of(context).textTheme.titleMedium!.copyWith(
