...
class MockTestScreenState extends ConsumerState<MCQMockTestHistoryScreen>
    with CommonWidgets {
  @override
  void initState() {
    super.initState();
