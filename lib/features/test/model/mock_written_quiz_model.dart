import '../../course/materials/test/model/written_test_details_model.dart';

class MockWrittenQuizResponse {
  bool? success;
  String? message;
  MockQuizData? data;

  MockWrittenQuizResponse({this.success, this.message, this.data});

  factory MockWrittenQuizResponse.fromJson(Map<String, dynamic> json) {
    return MockWrittenQuizResponse(
