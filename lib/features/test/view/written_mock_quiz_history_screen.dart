...
class WrittenMockQuizHistoryScreen extends ConsumerStatefulWidget {
  final String quizId;

  const WrittenMockQuizHistoryScreen({
    super.key,
...
class MockQuizScreenState extends ConsumerState<WrittenMockQuizHistoryScreen>
    with CommonWidgets {
  @override
  void initState() {
    super.initState();
