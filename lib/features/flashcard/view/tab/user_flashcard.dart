...
class UserFlashcardsTab extends ConsumerStatefulWidget {
  final VoidCallback onCreateTap;

  const UserFlashcardsTab({
    super.key,
    required this.onCreateTap,
  });

  @override
  UserFlashcardsTabState createState() => UserFlashcardsTabState();
}

class UserFlashcardsTabState extends ConsumerState<UserFlashcardsTab> {
  ...
  Widget _buildFlashcardList(
    ...
    final flashcardNotifier = ref.watch(userFlashcardsProvider.notifier);
